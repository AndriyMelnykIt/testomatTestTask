					...
					<div className="space-y-6">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Test the synchronous-style API client with automatic retries, session management, and timeout handling
								</CardDescription>
							</CardHeader>
							<CardContent>
					...
					<div className="space-y-6">
						<Card className="lg:sticky lg:top-6">
							<CardHeader>
								...
								<CardDescription>Real-time monitoring of all API requests</CardDescription>
							</CardHeader>
							<CardContent>
